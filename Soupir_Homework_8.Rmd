...
xyplot(head ~ age, data = db2, main = "Lambda = 1", xlab = "Age (years)",
       ...
       panel = pfun)
panel = pfun
ggplot(data = db, aes(y=head ,x= age))+geom_point()+geom_quantile(quantiles=tau,method = "rqss", lambda = 1)+ggtitle("Lambda=1")+xlab("Age (years)")+ylab("Head circumference (cm)")
...
xyplot(head ~ age, data = db2, main = "Lambda = 10", xlab = "Age (years)",
       ...
       panel = pfun)
panel = pfun
ggplot(data = db, aes(y=head ,x= age))+geom_point()+geom_quantile(quantiles=tau,method = "rqss", lambda = 10)+ggtitle("Lambda=10")+xlab("Age (years)")+ylab("Head circumference (cm)")
...
xyplot(head ~ age, data = db2, main = "Lambda = 20", xlab = "Age (years)",
       ...
       panel = pfun)
panel = pfun
ggplot(data = db, aes(y=head ,x= age))+geom_point()+geom_quantile(quantiles=tau,method = "rqss", lambda = 20)+ggtitle("Lambda=20")+xlab("Age (years)")+ylab("Head circumference (cm)")
...
xyplot(head ~ age, data = db2, main = "Lambda = 50", xlab = "Age (years)",
       ...
       panel = pfun)
panel = pfun
ggplot(data = db, aes(y=head ,x= age))+geom_point()+geom_quantile(quantiles=tau,method = "rqss", lambda = 50)+ggtitle("Lambda=50")+xlab("Age (years)")+ylab("Head circumference (cm)")
...
xyplot(head ~ age, data = db2, main = "Lambda = 100", xlab = "Age (years)",
       ...
       panel = pfun)
panel = pfun
ggplot(data = db, aes(y=head ,x= age))+geom_point()+geom_quantile(quantiles=tau,method = "rqss", lambda = 100)+ggtitle("Lambda=100")+xlab("Age (years)")+ylab("Head circumference (cm)")
```
